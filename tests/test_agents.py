...
async def test_alert_on_related_units_not_found(
    ...
    with monkeypatch.context() as con:
        ...
        mo.related_unit_registrations.return_value = (
            RelatedUnitRegistrationsRegistrations.parse_obj({"objects": []})
        )
...
async def test_alert_on_related_units_org_unit_not_in_loenorg(
    ...
    with monkeypatch.context() as con:
        ...
        mo.related_unit_registrations.return_value = (
            RelatedUnitRegistrationsRegistrations.parse_obj(
                {
                    "objects": [
                        {
...
async def test_alert_on_related_units_sends_email(
    ...
    with monkeypatch.context() as con:
        ...
        # The registration references a lønorg unit (via historical validities)
        mo.related_unit_registrations.return_value = (
            RelatedUnitRegistrationsRegistrations.parse_obj(
                {
                    "objects": [
        ...
        # The lønorg unit has no related_units (relation was removed)
        mo.org_unit_relations.return_value = OrgUnitRelationsOrgUnits.parse_obj(
            {
                "objects": [
                    {
...
async def test_alert_on_related_units_has_relation(
    ...
    with monkeypatch.context() as con:
        ...
        # The lønorg unit still has a relation to an adm org unit
        mo.org_unit_relations.return_value = OrgUnitRelationsOrgUnits.parse_obj(
            {
                "objects": [
                    {
