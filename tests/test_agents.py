...
from mo_smtp.autogenerated_graphql_client.get_manager_data import GetManagerDataManagers
...
async def test_alert_on_manager_removal_manager_not_found(context: Context):
    mo = AsyncMock()
    mo.manager_data.return_value = GetManagerDataManagers.parse_obj({"objects": []})
    with capture_logs() as cap_logs:
...
async def test_alert_on_manager_removal_currently_employed(context: Context):
    mo = AsyncMock()
    mo.manager_data.return_value = GetManagerDataManagers.parse_obj(
        {
            "objects": [
                {
                    "validities": [
